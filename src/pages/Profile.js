...
const ProfilePage = () => {
    ...
    const calculateProgress = (count) => {
        ...
        const percentage = Math.min(
            (solved / TOTAL_JAVA_PROBLEMS) * 100,
            100
        );
            ...
            <div style={styles.activityCard}>
                ...
                <div style={styles.progressBar}>
                    <div
                        style={{
                            ...styles.progressFill,
                            width: `${javaStats.percentage}%`,
                            background: javaStats.color
                        }}
                    />
                </div>

                <p style={styles.progressText}>
                    {Math.round(javaStats.percentage)}% of curriculum completed
                </p>
            ...
            <div style={styles.mainGrid}>
                ...
                <div style={styles.identityCard}>
                    ...
                    <div style={styles.infoRow}>
                        <span>Staff/Roll ID:</span>
                        <b>{user?.rollNo || 'FAME-001'}</b>
                    </div>

                    <div style={styles.infoRow}>
                        <span>Institution:</span>
                        <b>{user?.institution || 'FameHub'}</b>
                    </div>
                </div>
